...
const Offers = () => {
    return (
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-5xl mx-auto my-24'>
    {
        K.OFFERS.map((offer, index) => {
            ...
            return (
                <div className='relative bg-white rounded-lg shadow-lg p-6 flex flex-col gap-y-4 overflow-hidden transition-all duration-300 ease-in-out group'>
                    ...
                    <div className='absolute inset-0 bg-pink-500 transition-transform duration-300 ease-in-out transform translate-y-full group-hover:translate-y-0' />
                    <span className='p-3 bg-black w-fit text-white text-xl rounded-full z-10'>
